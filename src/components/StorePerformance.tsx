                        ...
                        {hoveredItem ? (
                            <>
                                ...
                                <div className="space-y-2 max-h-[500px] overflow-y-auto">
                                    ...
                                    {[...hoveredItem.stores]
                                        ...
                                        .map((product) => {
                                            const percentage = (product.revenue / hoveredItem.totalRevenue) * 100;
                                            const colorIndex = productList.indexOf(product.storeName);
                                            return (
                                                <div
                                                ...
                                                >
                                                    <div
                                                        ...
                                                        style={{
                                                            backgroundColor: PRODUCT_COLORS[colorIndex % PRODUCT_COLORS.length],
                                                        }}
                                                    />
                                                    <div className="flex-1 min-w-0">
                                                        ...
                                                        <div className="text-xs text-gray-600 dark:text-gray-400">
                                                            ¥{product.revenue.toLocaleString('ja-JP')} ({percentage.toFixed(1)}%)
                                                        </div>
                                                    </div>
                                                </div>
                                            );
                            ...
                            <div className="flex items-center justify-center h-[500px] text-gray-400 dark:text-gray-500">
                                <div className="text-center">
                                    <p className="text-sm">Hover over a store bar</p>
                                    <p className="text-xs mt-1">to see product breakdown</p>
                                </div>
                            </div>
                        )}
                    </div>
